          ...
          <div className="row">
            <div className="col-md-3">
              <div className="card-body" id="home-card-2">
                ...
                <p className="card-text">Plan your day, and share your thougts</p>
                <Link to="/dayjournal" className="dj-link">Open your journal...</Link>
              </div>
            </div>
            <div className="col-md-3">
              <div className="card-body" id="home-card-2">
          ...
          <div className="col-md-3">
            ...
            <div className="col-md-3">
              <div className="card-body" id="home-card-2">
                ...
                <p className="card-text">Take some time to reflect on your week</p>
                <Link to="/dayjournal" className="dj-link">Open your journal...</Link>
              </div><br/><br/>
            </div><br/><br/>
          </div>
