            ...
            <div className='row'>
              <div className='col-sm-6'>
                <div className='card border-info mb-3' id='home-card'>
                  ...
                  <div className='card-body text-info'>
                    ...
                    <p>
                      Break up your day into blocks of time. Pick a few details or
                      goals for each block and make a note for that time
                  </p>
                    <br />
              ...
              <div className='col-sm-6'>
                <div className='card border-info mb-3' id='home-card-2'>
                  ...
                  <div className='card-body text-info'>
                    <p className='card-text'>
                      Live your day! Usually the thought that you have decided how
                      you want to live your day will make you more aware of your
                      choices, assisting you to make better ones, that will allow
                      you to enjoy the present without robbing from the future .
                  </p>
                    <br />
                    <div className='row'>
            ...
            <div className='row'>
              <div className='col-sm-6'>
                <div className='card border-info mb-3' id='home-card-3'>
                  ...
                  <div className='card-body text-info'>
                    <p className='card-text'>
                      Pick a time toward the end of your day when you can journal.
                      Like in Step 1, fill in the blocks of time, but this time,
                      fill the day with how you actually it, adding notes and
                      details. Compare the two: how you wanted to live the day,
                      and how you chose to live it. Once you have your thoughts in
                      order, begin journaling.
                  </p>
                    <br />
                    <p>
                ...
                <div className='card border-info mb-3' id='home-card-4'>
                  ...
                  <div className='card-body text-info'>
                    <p className='card-text'>
                      ...
                      repeated "thought loop", usually related to something that
                      bothers you. Journaling about these "thought loops",
                      combined with taking a look at how you live each day, versus
                      how you could live, is an effective way of taking stock of
                      your troubles and goals, and can help to guide yourself to
                      different choices that can resolve issues and change your
                      life for the better.
                  </p>
                    <p>
                      It's important to note that there is no guaranteed cure all
                      to life's troubles, but journaling in this way can help to
                      ease them, at least. After all, it is better to adapt to
                      life than to wish for an easy one.
                  </p>
